...
<img width="1440" alt="Screenshot 2024-10-16 at 15 15 35" src="https://github.com/user-attachments/assets/bea3c658-8145-4b13-9457-797a636de060">
Login Screen:

Allows users to sign in with their Google account.
Secure login process using Firebase Authentication.

<img width="1440" alt="Screenshot 2024-10-16 at 15 14 09" src="https://github.com/user-attachments/assets/4c39092d-c9f1-4fa8-ac07-04565f0908b5">
Main Menu:
...
<img width="1440" alt="Screenshot 2024-10-16 at 15 14 21" src="https://github.com/user-attachments/assets/5647ce15-582f-4cc9-beb2-da41b055b864">
Add Note Section:
...
<img width="1440" alt="Screenshot 2024-10-16 at 15 14 32" src="https://github.com/user-attachments/assets/6a5eca32-99e2-4493-bfc1-c1ee4ad87ea4">
Profile Section:
...
Usage
Open the app and sign in with your Google account from the Login Screen.
Browse your notes in the main menu.
Click the Add Note button to create a new note.
Tap on an existing note to view or edit its content.
To delete a note, click on it and confirm the deletion option.
Update your user information or log out from the profile section.
